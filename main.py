...
# LEVEL DATA #
levels = [
    ("Set 'goal' to the result of 5 + 5 * 5", 30),
    ("Set 'goal' to be the sum of all odd numbers under 100", 2500),
    ("Find the sum of all the multiples of 3 or 5 below 1000.", 233168),
    ("Each new term in the Fibonacci sequence is generated by adding the previous two terms. Start with 1, 2, 3, 5 and so on. Find the sum of the even fibonacci numbers less than 4,000,000.", 4613732),
    ("You completed all of the levels!", None),
]
...
while not closed:
    ...
    if toggleables["d_prob"]: graphics.display_problem(f"LEVEL {current_level}: {levels[current_level-1][0]}")
